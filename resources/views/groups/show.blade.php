                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center slider-text">
                        <div class="slider-text-inner">
                            <h1 class="heading-section">{{$group->title}}</h1>
                                <h2>{{$group->notes}}... <a href="http://freehtml5.co/" target="_blank">Business</a></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 animate-box fadeInUp animated-fast">
                <div class="course">
                    ...
                    <div class="desc">
                        ...
                        <p>{{ str_limit($subject->notes, 150)}}</p>
                        <span><a href="{{ $subject->path() }}" class="btn btn-primary btn-sm btn-course">Take A Tour</a></span>
                    </div>
                </div>
            </div>
            @endforeach
