                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center slider-text">
                        <div class="slider-text-inner">
                            <h1 class="heading-section">Technology</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6 animate-box fadeInUp animated-fast">
                <div class="course">
                    ...
                    <div class="desc">
                        <h3><a href="#">{{$group->title}}</a></h3>
                        <p>{{ str_limit($group->notes, 150)}}</p>
                        <span><a href="{{ $group->path() }}" class="btn btn-primary btn-sm btn-course">Take A Tour</a></span>
                    </div>
                </div>
            </div>
            @endforeach
